...
{   
    echo "<div class='plan'> <h2 style='color:red;' class='plan-title'>".$row[0]."</h2>";

	echo "<embed src='data:".$row[10].";base64,".$row[11]."' height=115 />
    <ul class='plan-features'><hr>";
 
 echo "<li style='color:green;'>Бренд           - <b style='color:black;'>{$row[1]}</b> </li>";
 echo "<li style='color:green;'>Базовая частота - <b style='color:black;'>{$row[2]}</b> </li>";
 echo "<li style='color:green;'>Boost частота   - <b style='color:black;'>{$row[3]}</b> </li>";
 echo "<li style='color:green;'>Ядра            - <b style='color:black;'>{$row[4]}</b> </li>";
 echo "<li style='color:green;'>Тип памяти      - <b style='color:black;'>{$row[5]}</b> </li>";
 echo "<li style='color:green;'>Размер памяти   - <b style='color:black;'>{$row[6]}</b> </li>";
 echo "<li style='color:green;'>TGP             - <b style='color:black;'>{$row[7]}</b> </li>";
