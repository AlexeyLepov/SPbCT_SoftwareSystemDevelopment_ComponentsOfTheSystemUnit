                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
											...
											<li><a href="#">Редактор индексированных таблиц <i class="ti-angle-down"></i></a>
												<ul class="submenu">
													<li><a href="'.$CD_path.'CRUD/Indexed/CRUD_Brend_Proc.php">Процессорные бренды</a></li>
													<li><a href="'.$CD_path.'CRUD/Indexed/CRUD_Brend.php">Бренды-вендоры</a></li>
													<li><a href="'.$CD_path.'CRUD/Indexed/CRUD_User_Roles.php">Роли пользователей</a></li>
                                                </ul>
                                            </li>
